...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#----------------------------------- Q 6 Successful Projects--------------------------------------------------------------# 
Select  sum(pledged) as Total_amt_raised , sum(backers_count) as total_Backers   from projects where state= 'successful'; #on basis of backers  and amount 
...
FROM 
    projects
WHERE 
    state = 'successful'; # on the basis of amount avarage no of days 
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#---------------------------Percentage of Successful Projects overall------------------------------------------------------#
SELECT 
    (COUNT(CASE WHEN state = 'successful' THEN 1 END) * 100.0 / COUNT(*)) AS OverallSuccessRate
FROM 
    projects;
...
FROM crowdfunding_location_sql l
...
JOIN 
    crowdfunding_category_sql ON projects.category_ID = crowdfunding_category_sql.ID
GROUP BY 
    crowdfunding_category_sql.Name order by Totalprojects desc;
    
    #-----------------------------------Total Number of Projects created by Year , Quarter , ----------------------#
